...
public class SearchStack {
    ...
    public static void main (String [] args) {
      ...
      // But in stack LIFO terms: we count from the top of the stack so the String "Adult Human" is at position 4 from the top of the stack
      // we can also use other generic way of creating stack with specific data type, for example Stack<Integer> or Stack<String> etc.
      // Baisically we're just setting rules on what data type the stack will accept
